...
int x_rest=333, x_min=270, x_max=400;
int y_rest=335, y_min=270, y_max=400;
int z_rest=420, z_min=350, z_max=425;
int range = 3;
float range_rotation_pitch = 0.2, range_rotation_roll = 0.4, range_rotation_yaw = 0.4;
...
void readIMU() {
  ...
  float mappedYaw = mapf(pitch, -50, -30, -range_rotation_yaw, range_rotation_yaw);
  ...
  if (moveMotors) {
    rotation.x = mappedPitch;
    rotation.y = mappedRoll;
    // do not use
    // rotation.z = mappedYaw; 
  }
}
